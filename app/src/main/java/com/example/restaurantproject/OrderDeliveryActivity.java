...
public class OrderDeliveryActivity extends AppCompatActivity {
    private EditText edtCustomerName, edtCustomerAddress, edtNote;
    private Spinner spnRestaurant;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtCustomerName = findViewById(R.id.edt_customer_delivery_name);
        edtNote = findViewById(R.id.edt_order_note_delivery);
        edtCustomerAddress = findViewById(R.id.edt_customer_delivery_address);
        spnRestaurant = findViewById(R.id.spn_restaurant_delivery);
        ...
        if (sessionManager.isLoggedIn()) {
            ...
            if(loggedInAccount != null) {
                ...
                edtCustomerAddress.setText(loggedInAccount.getAddress());
            }
        }
        ...
        tvTotalPrice = findViewById(R.id.view_total_price_delivery);

        // Set up button click listener
        btnAddMore = findViewById(R.id.btn_add_more_order_item_delivery);
        btnAddMore.setOnClickListener(v -> addMoreItem());

        btnOrder = findViewById(R.id.btn_add_order_delivery);
        btnOrder.setOnClickListener(v -> addOrder());

        btnCancel = findViewById(R.id.btn_cancel_add_order_delivery);
    ...
    private void viewListOrderItem() {
        rcvOrderItem = findViewById(R.id.list_dish_ordered_recycler_view_delivery);
        orderDTOList.clear();
    ...
    private void addMoreItem() {
        ...
        if (selectedRestaurantId > 0) {
            Intent intent = new Intent(OrderDeliveryActivity.this, MenuOrderActivity.class);
    ...
    private void addOrder() {
        ...
        order.setAddress(edtCustomerAddress.getText().toString());
        ...
        if (orderRepository != null && orderDetailsRepository != null) {
            ...
            delivery.setNote(edtNote.getText().toString());
